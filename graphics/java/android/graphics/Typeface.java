...
public class Typeface {
    ...
    public static void init() {
        ...
        preloadFontFile(SystemFonts.SYSTEM_FONT_DIR + "Mejiro-Bold.ttf");
        preloadFontFile(SystemFonts.SYSTEM_FONT_DIR + "Mejiro-Extrabold.ttf");
        preloadFontFile(SystemFonts.SYSTEM_FONT_DIR + "Mejiro-Light.ttf");
        preloadFontFile(SystemFonts.SYSTEM_FONT_DIR + "Mejiro-Regular.ttf");
        preloadFontFile(SystemFonts.SYSTEM_FONT_DIR + "Mejiro-Semibold.ttf");
        preloadFontFile(SystemFonts.SYSTEM_FONT_DIR + "Mejiro-Thin.ttf");
