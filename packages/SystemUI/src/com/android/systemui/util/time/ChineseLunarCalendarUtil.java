/*
 * SPDX-FileCopyrightText: The exTHmUI Open Source Project
...
public class ChineseLunarCalendarUtil {
    ...
    private static final String[] YEAR_TIANGAN = new String[]{
            "甲", "乙", "丙", "丁", "戊", "己", "庚", "辛", "壬", "癸"
    };
    private static final String[] YEAR_DIZHI = new String[]{
            "子", "丑", "寅", "卯", "辰", "巳", "午", "未", "申", "酉", "戌", "亥"
    };
    private static final String[] YEAR_CHINESE_ZODIAC = new String[]{
    ...
    private ChineseLunarCalendarUtil() {
        // Utility class
    }
    ...
    private static String convYear(int year, boolean zodiac) {
        ...
        int tiangan = y % 10;
        int dizhi = y % 12;
        return YEAR_TIANGAN[tiangan]
                + YEAR_DIZHI[dizhi]
                + (zodiac ? YEAR_CHINESE_ZODIAC[dizhi] : "")
                + "年";
    }
